...
This paper is not a new technical phase and does not introduce new physical claims. It serves as release \texttt{66.1}, the canonical entry document for HAOS-IIP. Its purpose is to translate the program into standard mathematical and computational language, define its minimal assumptions, separate internal numerical results from external bridge hypotheses, compare the framework with nearby established approaches, and state explicit falsification gates.
