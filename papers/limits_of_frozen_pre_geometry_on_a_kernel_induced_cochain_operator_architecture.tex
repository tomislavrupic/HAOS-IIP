...
For external distribution, this paper is the Phase I capstone release. The full stack of supporting experiment notes, numerical solvers, staged atlases, and generated outputs is archived separately in the repository and frozen at Zenodo DOI 10.5281/zenodo.18938323. The role of the present paper is therefore compressive rather than exhaustive: it gives the citable boundary statement, while the archive retains the stage-by-stage mechanics.
...
For readability, the full sequence can be compressed into four blocks:
\begin{itemize}
\item Part I: architecture and sector construction (00.1--04.1),
\item Part II: transport and morphology (05.1--10.1),
\item Part III: collective organization (11.1--13.1),
\item Part IV: boundary limit (14.1--18.1).
\end{itemize}
