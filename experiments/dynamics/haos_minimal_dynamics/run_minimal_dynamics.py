...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--null-level", type=int, choices=(1, 2, 3, 4, 5), default=4, help="Specificity null strictness: 1 degree/shell, 2 spectral-aware, 3 autocorrelation, 4 higher-order, 5 trajectory.")
...
def main() -> None:
    ...
    print(f"higher_order_z: {outcome['observed_summary']['higher_order_z']}")
    print(f"trajectory_z: {outcome['observed_summary']['trajectory_z']}")
    ...
    print(f"control_higher_order_pass_count: {outcome['control_higher_order_pass_count']}")
    print(f"control_trajectory_pass_count: {outcome['control_trajectory_pass_count']}")
