...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--null-level", type=int, choices=(1, 2, 3, 4), default=3, help="Specificity null strictness: 1 degree/shell, 2 spectral-aware, 3 spectral+autocorrelation, 4 higher-order.")
