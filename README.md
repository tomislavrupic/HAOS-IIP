...
**66.4 Canonical Entry Paper** - a clean overview in standard language:
[PDF](papers/pdf_releases/66.4%20HAOS-IIP%20Canonical%20Entry%20Paper%20-%20Translation%20and%20Hostile-Audit%20Layer.pdf)
/
[Markdown](docs/notes/foundations/HAOS_IIP_Canonical_Entry_Paper_v1.md)

Start here for a clean, standard-language overview with translation tables and falsification gates.
...
- Phase 66 translation and hostile-audit entry layer `66.4`, which gives skeptical readers the public entry path: standard-language terms first, minimal assumptions, frozen-regime setup, recoverability diagnostics, framework comparison, falsification gates, claim-gating, reproduction path, footer/page-number polish, title-page subtitle, copy-clean ASCII-hyphen list labels, and explicit non-claims
...
- [Canonical entry paper](docs/notes/foundations/HAOS_IIP_Canonical_Entry_Paper_v1.md) is the readable public entry document for a skeptical technical reader.
...
The continuum-facing roadmap and scale-bridge audit are:

- [Continuum Physics Scaling Roadmap](docs/notes/foundations/HAOS_IIP_Continuum_Physics_Scaling_Roadmap_v1.md)
- [Scale-Bridge Legitimacy Audit](docs/notes/foundations/HAOS_IIP_Scale_Bridge_Legitimacy_Audit_v1.md)
